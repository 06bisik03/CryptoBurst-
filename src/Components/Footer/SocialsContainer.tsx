...
const HashtagIcon: React.FC = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" height="1.15em" style={{aspectRatio: '1/1',paddingTop: '.2em'}}>
